...
3.  **The Rules of Speech**: You MUST only use words with **ONE SYLLABLE**.
    ...
    *   *Wrong*: "Tube used to see planets" (**Plan-ets** has two syllables — **PENALTY!**)
4.  **The Judge**: One player is designated as the "Judge" each round. They will call a PENALTY if you use a big word!
